...
<ul id="drop">
      ...
      <li><a href="">staff</a>
        ...
        <li><a href="admin.php">view staff member details</a></li><br />
        </ul>
      </li>
...
<tr><td>username:</td><td width="50"><input type="text" name="supername" /></td></tr>
<tr><td>current password:</td><td width="50"><input type="password" name="superpass" /></td></tr>
