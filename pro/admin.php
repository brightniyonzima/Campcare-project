...
<div id="accordion">
<p align="justify">Search staff member</p>
<table>
...
/*query the database*/
$query = "select * from staff where username like '%".$searchterm."%'";
...
echo "$num_found. ".($row['fname'])." ".($row['lname'])." "."<b>&nbsp;email:</b>".($row['email'])."<b>&nbsp;contact:</b>".($row['contact'])." <br />";
}
/*free database*/
$result->free();
$dbconn->close();
