...
<br />
<div id="accordion">
<caption><font color="#660033">CHECK FOR POSSIBLE RELATIVE</font></caption>
<table height="300" width="380" align="center">
  <form id="form1" name="form1" method="post" action="check.php">
    <tr><td>first name</td><td>
    <input type="text" name="fname" onkeyup="checkName(this)"/></td></tr>
	<tr><td>last name</td><td>
    <input type="text" name="lname" onkeyup="checkNames(this)"/></td></tr>
    <tr><td></td><td><input type="radio" name="gender" value="male" />male
    ...
    <tr><td>origin</td><td>
    <input type="text" name="origin" /></td></tr>
     <tr><td></td><td><input type="submit" name="Submit" value="check" />
...
<ol>
<li>To search for any possible traces of relatives,make use of the above form.</li>
<li>Make sure the information entered is correct to avoid inaccuracy and slowing the system down</li>
</ol>
